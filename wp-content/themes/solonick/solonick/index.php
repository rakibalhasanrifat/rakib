            ...
            <div id="wrapper" class="single-page-wrap">
                ...
                <div class="content">
                    ...
                    <section data-scrollax-parent="true" id="sec1">
                        <div class="section-subtitle left-pos"  data-scrollax="properties: { translateY: '-250px' }" ><span>//</span><?php if(!empty($solonick_options['blogtitle'])):?><?php echo esc_attr(Solonick_AfterSetupTheme::return_thme_option('blogtitle',''));?><?php else :?><?php esc_html_e('Blog','solonick');?><?php endif;?></div>
                        <div class="container">
