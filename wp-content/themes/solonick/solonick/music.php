            ...
            <div id="wrapper" class="single-page-wrap">
                ...
                <div class="content">
                    ...
                    <section data-scrollax-parent="true" id="sec1">
                        ...
                        <div class="container">
						<?php if (( get_post_meta($post->ID,'rnr_music-port-filter',true))=='no'):?>
						<?php else : ?>
						<?php if(!get_post_meta(get_the_ID(), 'music_category', true)):
						$solonick_music_category = get_terms('music_category');?>
						<?php if($solonick_music_category):?>
                            <!-- filter -->
                            <div class="filter-holder inline-filter fl-wrap  mar-bottom">
                                ...
                                <div class="gallery-filters">
									...
									<?php  foreach($solonick_music_category as $solonick_music_cat):?>
                                    <a href="#" class="gallery-filter" data-filter=".<?php echo esc_attr($solonick_music_cat->slug);?>"><?php echo esc_attr($solonick_music_cat->name);?></a>
                                    <?php endforeach;?>
                                </div>
							...
							<?php $solonick_showpost= get_post_meta($post->ID, 'rnr_music-post-show', true);$solonick_categoryname= get_post_meta($post->ID, 'rnr_music-post-cat', true);
							$solonick_paged=(get_query_var('paged'))?get_query_var('paged'):1;
							$solonick_loop = new WP_Query( array( 'post_type' => 'music', 'posts_per_page'=>$solonick_showpost, 'music_category'=> $solonick_categoryname, 'paged'=>$solonick_paged ) ); ?>
