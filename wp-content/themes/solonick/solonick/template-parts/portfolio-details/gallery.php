...
<!--wrapper-->
            <div id="wrapper" class="single-page-wrap">
                ...
                <div class="content">
					...
					<?php $solonick_images = rwmb_meta( 'rnr_so_po_page_header_back','type=image&size=' );
					...
					<section class="parallax-section dark-bg sec-half parallax-sec-half-right" data-scrollax-parent="true">
                        ...
                        <div class="container">
                            <div class="section-title">
							    <?php if (( get_post_meta($post->ID,'rnr_so_po_page_header_title',true))):?>
                                <h2><?php echo do_shortcode(get_post_meta($post->ID,'rnr_so_po_page_header_title',true)) ?></h2>
								<?php else: ?>
                                <h2><?php the_title();?></h2>
								<?php endif;?>
                                <p> <?php echo esc_html(get_post_meta($post->ID,'rnr_bl-port-short-opt',true)); ?></p>
                                <div class="horizonral-subtitle"><span><?php echo esc_html(get_post_meta($post->ID,'rnr_bl-port-horizonral-title-opt',true)); ?></span></div>
                            </div>
