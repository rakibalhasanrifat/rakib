...
<!--wrapper-->
            <div id="wrapper" class="single-page-wrap">
                ...
                <div class="content">
					...
					<?php $solonick_images = rwmb_meta( 'rnr_so_po_page_header_back3','type=image&size=' );
					...
					<section class="parallax-section fw-parallax" data-scrollax-parent="true">
                        ...
                        <div class="container">
                            <div class="section-title">
                                <?php if (( get_post_meta($post->ID,'rnr_so_po_page_header_title3',true))):?>
                                <h2><?php echo do_shortcode(get_post_meta($post->ID,'rnr_so_po_page_header_title3',true)) ?></h2>
								<?php else: ?>
                                <h2><?php the_title();?></h2>
								<?php endif;?>
                                <p> <?php echo esc_html(get_post_meta($post->ID,'rnr_bl-port-short-opt3',true)); ?></p>
                                <div class="horizonral-subtitle"><span><?php echo esc_html(get_post_meta($post->ID,'rnr_bl-port-horizonral-title-opt3',true)); ?></span></div>
                            </div>
                        </div>
										...
										<?php endif;?>
                                            ...
                                            <div class="single-media-container fl-wrap">
												...
												foreach ( $solonick_image_ids as $solonick_image_id ) {
													$solonick_image = RWMB_Image_Field::file_info( $solonick_image_id, array( 'size' => 'solonick_portfolio_image' ) ); ?>
                                                        <div class="slick-slide-item"><img src="<?php echo esc_url(($solonick_image['url']));?>" alt="<?php echo esc_html(($solonick_image['title']));?>"></div>
													<?php } } } ;?>
