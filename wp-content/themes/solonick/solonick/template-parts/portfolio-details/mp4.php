                ...
                <div class="content full-height">
                    ...
                    <section class="no-padding full-height">
					       ...
					       $solonick_image = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), '' );?>
							...
							<div class="video-container">
                                <video autoplay  loop muted  class="bgvid">
                                    <source src="<?php echo esc_attr(get_post_meta($post->ID,'rnr_bl-port-video-mp-id',true)); ?>" type="video/mp4">
                                </video>
                            </div>
                        ...
                        <div class="half-hero-wrap">
                            <?php if (( get_post_meta($post->ID,'rnr_bl-port-video-tit-mp4',true))):?>
                                <h1><?php echo do_shortcode(get_post_meta($post->ID,'rnr_bl-port-video-tit-mp4',true)) ?></h1>
								<?php else: ?>
                                <h1><?php the_title();?></h1>
								<?php endif;?>
							<?php if (( get_post_meta($post->ID,'rnr_bl-port-video-subtit-mp4',true))):?>
                            <h4><?php echo esc_html(get_post_meta($post->ID,'rnr_bl-port-video-subtit-mp4',true)); ?></h4>
							<?php endif;?>
                            ...
                            <div class="fl-wrap">
								...
								<?php endif;?>
										...
										<?php endif;?>
											...
											<?php if (( get_post_meta($post->ID,'rnr_bl-port-video-mp',true))):?>
											<!-- det box-->
                                            <div class="fl-wrap ">
                                                <div class="iframe-holder fl-wrap">
                                                    <div class="resp-video">
                                                        <iframe src="<?php echo esc_url(get_post_meta($post->ID,'rnr_bl-port-video-mp',true)); ?>" width="640" height="360" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                                                    </div>
                                                </div>
                                            </div>
											<?php endif;?>
                                            <div class="clearfix"></div>
											<?php if (( get_post_meta($post->ID,'rnr_md_mp4_gallery_enable',true))=='st2'):?>
                                            <div class="fl-wrap">
                                                <!-- portfolio start -->
