                    ...
                    <section class="no-padding full-height">
						...
						<div class="video-holder">
					       ...
					       $solonick_image = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), '' );?>
							...
							<?php endif;?>
                            <div  class="background-vimeo" data-vim="<?php echo esc_attr(get_post_meta($post->ID,'rnr_bl-port-video-vm-id',true)); ?>"> </div>
                        </div>
                        </div>
                        <div class="overlay"></div>
                        <div class="half-hero-wrap">
                            <?php if (( get_post_meta($post->ID,'rnr_bl-port-video-tit-vm',true))):?>
                                <h1><?php echo do_shortcode(get_post_meta($post->ID,'rnr_bl-port-video-tit-vm',true)) ?></h1>
								<?php else: ?>
                                <h1><?php the_title();?></h1>
								<?php endif;?>
							<?php if (( get_post_meta($post->ID,'rnr_bl-port-video-subtit-vm',true))):?>
                            <h4><?php echo esc_html(get_post_meta($post->ID,'rnr_bl-port-video-subtit-vm',true)); ?></h4>
							<?php endif;?>
                            ...
                            <div class="fl-wrap">
								...
								<?php endif;?>
										...
										<?php endif;?>
											...
											<?php if (( get_post_meta($post->ID,'rnr_bl-port-video-vm',true))):?>
											<!-- det box-->
                                            <div class="fl-wrap ">
                                                <div class="iframe-holder fl-wrap">
                                                    <div class="resp-video">
                                                        <iframe src="<?php echo esc_url(get_post_meta($post->ID,'rnr_bl-port-video-vm',true)); ?>" width="640" height="360" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                                                    </div>
                                                </div>
                                            </div>
											<?php endif;?>
                                            <div class="clearfix"></div>
											<?php if (( get_post_meta($post->ID,'rnr_md_vimeo_gallery_enable',true))=='st2'):?>
                                            <div class="fl-wrap">
                                                <!-- portfolio start -->
