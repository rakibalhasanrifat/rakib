                ...
                <div class="content">
                    ...
                    <section class="no-padding dark-bg sinsec-dec">
                        <div class="single-project-title fl-wrap">
                            <h2><span class="caption"><?php the_title();?></span></h2>
                        </div>
								...
								<?php $solonick_gallery_pop = isset( $solonick_car_slide_opts['rnr_so_port_gallery_video_opt'] ) ? $solonick_car_slide_opts['rnr_so_port_gallery_video_opt'] : ''; ?>
                                    <!-- swiper-slide-->
										...
										foreach ( $solonick_image_ids as $solonick_image_id ) {
											$solonick_image = RWMB_Image_Field::file_info( $solonick_image_id, array( 'size' => 'solonick_portfolio_image_gallery_car' ) ); ?>
                               
							   <!-- show-case-item -->   
                                <div class="show-case-item" data-curtext="<?php echo esc_html(($solonick_image['caption']));?>">
                                    <div class="show-case-wrapper fl-wrap full-height">
										...
										<a href="<?php echo esc_html($solonick_gallery_pop);?>" class="fet_pr-carousel-box-media-zoom   popup-image"><i class="fal fa-play"></i></a>
										<?php } else { ?>
                                        <a href="<?php echo esc_url(($solonick_image['url']));?>" class="fet_pr-carousel-box-media-zoom   popup-image"><i class="fal fa-search"></i></a>
										<?php } ;?>
                                        <div class="show-info">
                                            <span><?php if(!empty($solonick_options['translet_opt_10'])):?><?php echo esc_html(Solonick_AfterSetupTheme::return_thme_option('translet_opt_10',''));?><?php else : ?><?php esc_html_e('Info','solonick');?><?php endif;?></span> 
                                            <div class="tooltip-info">
                                                <h5><?php echo esc_html(($solonick_image['caption']));?></h5>
                                                <p><?php echo esc_html(($solonick_image['description']));?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
