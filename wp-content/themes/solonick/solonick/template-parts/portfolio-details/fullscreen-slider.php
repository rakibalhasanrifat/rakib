                        ...
                        <div class="slider-carousel-wrap full-height fullscreen-slider-wrap">
                            <div class="fullscreen-slider full-height cur_carousel-slider-container fl-wrap">
                                ...
                                <div class="fullscreen-slider-item full-height fl-wrap">
                                    <div class="bg par-elem"  data-bg="<?php echo esc_url($solonick_image[0]);?>"></div>
                                    ...
                                    <div class="half-hero-wrap">
										...
										<h1><?php echo do_shortcode(get_post_meta($post->ID,'rnr_bl-port-tit-opt',true)) ?></h1>
										<?php else: ?>
										<h1><?php the_title();?></h1>
										<?php endif;?>
                                        <?php if (( get_post_meta($post->ID,'rnr_bl-port-subt-tit-opt',true))):?>
										<h4><?php echo esc_html(get_post_meta($post->ID,'rnr_bl-port-subt-tit-opt',true)); ?></h4>
										<?php endif;?>
                                    </div>
                                </div>
