					...
					<?php endif;?>
                        ...
                        <div class="container">
                            <div class="section-title">
								<?php if (( get_post_meta($post->ID,'rnr_so_port_page_header_title',true))):?>
                                <h2><?php echo do_shortcode(get_post_meta($post->ID,'rnr_so_port_page_header_title',true)) ?></h2>
								<?php else : ?>
								<h2><?php the_title();?></h2>
								<?php endif;?>
                                <p> <?php echo esc_html(get_post_meta($post->ID,'rnr_so_port_page_header_short_title',true)); ?> </p>
                                <div class="horizonral-subtitle"><span><?php echo esc_html(get_post_meta($post->ID,'rnr_so_port_page_header_hor_title',true)); ?></span></div>
                            </div>
